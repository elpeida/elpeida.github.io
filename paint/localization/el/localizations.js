...
loaded_localizations("el", {
	"Extras": "Πρόσθετα",
	"History": "Ιστορικό",
	"Manage Storage": "Διαχείριση αποθηκευτικού χώρου",
	"Render History As GIF": "Απόδοση ιστορικού ως gif",
	"Multi-User": "Πολλαπλοί χρήστες",
	"Themes": "Θέματα",
	"Language": "Γλώσσα",
	"Eye Gaze Mode": "Λειτουργία Eye Gaze",
	"Speech Recognition": "Αναγνώριση φωνής",
	"Vertical Color Box": "Κάθετο κουτί χρωμάτων",
	"Project News": "Νέα του Έργου",
	"Donate": "Δωρεά",
	...
	"Winter": "Χειμώνας",
	"Occult": "Μυστηριώδες",
	"New Session From Document": "Νέα συνεδρία από έγγραφο",
	"New Blank Session": "Νέα κενή συνεδρία",
	"Save as type": "Αποθήκευση ως τύπος",
	"Paste or type the web address of an image": "Επικόλλησε ή πληκτρολόγησε την ηλεκτρονική διεύθυνση μιας εικόνας",
	"Load from URL": "Φόρτωση από URL",
	"Upload to Imgur": "Ανέβασμα στο Imgur",
	"Upload": "Ανέβασμα",
	"Any images you've saved to your computer with <b>File > Save</b> will not be affected.": "Οι εικόνες που αποθηκεύσατε στον υπολογιστή σας με <b>Αρχείο > Αποθήκευση</b> δεν θα επηρεαστούν.",
	"Redo": "Επανάληψη",
	"To view all branches of the history tree, click <b>Edit > History</b>.": "Για να δείτε όλα τα κλαδιά του δέντρου του ιστορικού, πατήστε <b>Επεξεργασία > Ιστορικό</b>.",
	"Document History": "Ιστορικό εγγράφου",
	"Start of History": "Αρχή του ιστορικού",
	"Linear timeline": "Γραμμικό χρονοδιάγραμμα",
	"Tree": "Δέντρο",
	"&Basic colors:": "Βασικά χρώματα:",
	"&Custom colors:": "Προσαρμοσμένα χρώματα:",
	"&Define Custom Colors >>": "Προσαρμογή χρωμάτων >>",
	"Failed to render GIF.": "Αποτυχία δημιουργίας GIF",
	"Details": "Λεπτομέρειες",
	"Multi-User Setup": "Διάταξη για πολλαπλούς χρήστες",
	...
	"Zoom to": "Ζουμ κατά",
	"Zoom To &Window": "Ζουμ στο παράθυρο",
